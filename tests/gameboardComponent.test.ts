...
gameBoard.randomPlacingShips(new Ship(6));
gameBoard.randomPlacingShips(new Ship(5));
gameBoard.randomPlacingShips(new Ship(5));
gameBoard.randomPlacingShips(new Ship(4));
gameBoard.randomPlacingShips(new Ship(4));
gameBoard.randomPlacingShips(new Ship(3));
gameBoard.randomPlacingShips(new Ship(2));
gameBoard.randomPlacingShips(new Ship(1));
